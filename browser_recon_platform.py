...
def dorking(targetDomain,timer,targetName,maxtabs):
...
def sites_recon(targetDomain,timer,targetName,maxtabs):
    google_walker(paste_sites,targetDomain,timer,targetName,maxtabs)

def social_recon(targetDomain,timer,targetName,maxtabs):
    google_walker(social_sites,targetDomain,timer,targetName,maxtabs)

def filetype_recon(targetDomain,timer,targetName,maxtabs):
    file_walker(filetype_list,targetDomain,timer,targetName,maxtabs)
...
def maybe_skip_this(subroutine,autofire):
    ...
    if cntinue == "s":
        ...
        print("\n")
        subroutine(targetDomain,timer,targetName,maxtabs)
...
for subroutine in subroutines:
    print(subroutine[0])
    maybe_skip_this(subroutine[1],autofire)
