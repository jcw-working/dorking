...
parser.add_option("-m", "--maxtabs", help='Maximum number of tabs fired at your browser before prompting, with the expectation taht you will close the browser.  Default is 10.  Best if it is an even number!')
